...
class iBurgerShop extends JFrame {
	...
	public void homepage() {		
		...
		JLabel imgPanel = new JLabel(new ImageIcon("homepage.jpg"));
		add("West",imgPanel);
	...
	public void updateOrder() {
		...
		String[] orderStatusBoxItems = {"Preparing","Cancelled","Delivered"};
